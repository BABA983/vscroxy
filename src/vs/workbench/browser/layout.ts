...
export abstract class Layout extends Disposable implements IWorkbenchLayoutService {
	...
	protected createWorkbenchLayout(): void {
		...
		this.bannerPartView = titleBar;
		this.sideBarPartView = titleBar;
		this.activityBarPartView = titleBar;
		this.editorPartView = titleBar;
		this.panelPartView = titleBar;
		this.auxiliaryBarPartView = titleBar;
		this.statusBarPartView = titleBar;
