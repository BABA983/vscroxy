...
export class GlobalActivityActionViewItem extends AbstractGlobalActivityActionViewItem {
	...
	constructor(
		...
		const action = instantiationService.createInstance(CompositeBarAction, {
			...
			classNames: ThemeIcon.asClassNameArray(Codicon.settingsGear)
		});
		...
		super(() => simpleActivityContextMenuActions(storageService, true),
			{
				...
				hoverOptions,
				compact: true,
			}, () => undefined, actions => actions, themeService, lifecycleService, hoverService, contextMenuService, menuService, contextKeyService, environmentService, productService, configurationService, keybindingService, logService, activityService, instantiationService, commandService);
	}
}
		...
		super(() => simpleActivityContextMenuActions(storageService, false),
			{
				...
				hoverOptions,
				compact: true,
			}, () => undefined, themeService, hoverService, menuService, contextMenuService, contextKeyService, configurationService, environmentService, keybindingService, instantiationService, activityService);
	}
}
