...
import { IProxyWindow, LoadReason, UnloadReason } from '../../window/electron-main/window.js';
...
export interface ILifecycleMainService {
	 ...
	 */
	readonly onBeforeCloseWindow: Event<IProxyWindow>;

	/**
	 * Make a `ICodeWindow` known to the lifecycle main service.
	 */
	registerWindow(window: IProxyWindow): void;

	/**
	 * Reload a window. All lifecycle event handlers are triggered.
	 */
	reload(window: IProxyWindow, cli?: NativeParsedArgs): Promise<void>;

	/**
	 * Unload a window for the provided reason. All lifecycle event handlers are triggered.
	 */
	unload(window: IProxyWindow, reason: UnloadReason): Promise<boolean /* veto */>;
...
export class LifecycleMainService extends Disposable implements ILifecycleMainService {
	...
	private readonly _onBeforeCloseWindow = this._register(new Emitter<IProxyWindow>());
	...
	async reload(window: IProxyWindow, cli?: NativeParsedArgs): Promise<void> {
	...
	private async doUnload(window: IProxyWindow, reason: UnloadReason): Promise<boolean /* veto */> {
	...
	private onBeforeUnloadWindowInRenderer(window: IProxyWindow, reason: UnloadReason): Promise<boolean /* veto */> {
	...
	private onWillUnloadWindowInRenderer(window: IProxyWindow, reason: UnloadReason): Promise<void> {
